...
1. **Create ONE failure log**: `/opt/workspaces/login/.autoflow/.failures/sprint-{ID}-e2e-tests.md` (use absolute path from project root)
...
7. **CRITICAL - IF ANY TESTS FAIL**:
   - **YOU MUST** use the Write tool to create `/opt/workspaces/login/.autoflow/.failures/sprint-{ID}-e2e-tests.md`
